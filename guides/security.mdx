...
<Warning>
    The Haunt.gg Team does not ask for your credentials in your direct messages. If you receive a message asking for your credentials, it is a phishing attempt. Please report it to our team on [Discord](https://discord.gg/hauntgg).
</Warning>
...
<Steps>
    <Step title="Create a Password">
        Create a safe password with a combination of uppercase, lowercase, numbers and special characters. (Here is a password generator that creates a safe password: [1password](https://1password.com/password-generator))
    </Step>
...
<Steps>
    ...
    <Step Title="Enter your verification code">
        Enter the verification code that you received in your Authenticator app. Then press on the Verify & Enable button
        <Frame>
...
<Info>
    Please contact our support via our ticket system on [Discord](https://discord.gg/hauntgg) to recover your account.
</Info>