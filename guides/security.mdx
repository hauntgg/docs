...
<Steps>
    <Step title="Create a Password">
        Create a safe password with a combination of uppercase, lowercase, numbers and special characters. (Here is a password generator that creates a safe password for you: [1password](https://1password.com/password-generator))
    </Step>
