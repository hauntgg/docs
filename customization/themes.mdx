...
<Steps>
  <Step title="Open the Section">
    Go to the **Social Integration Customization** section.
  </Step>
  <Step title="Adjust Presence">
    Toggle visibility for different Discord presence options like decorations, status, tags, and more.
  </Step>
</Steps>

<Frame>
  ![Social Integration Customization Interface](../images/presence-customization.png)
</Frame>
